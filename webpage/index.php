    ...
    $pattern10="/(([0-9]){4} ){3}[0-9]/";
  	if(preg_match($pattern10, $credit)) {
						$match="Correct";
						 ...
						 $creditErr ="Invalid  number";
					}
}

if (empty($_POST["creditexp"])) {
    $creditexpErr = "Expiry date is required";
  } else { 
